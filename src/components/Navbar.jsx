...
const Navbar = () => {
  ...
  return (
    <nav className={`sticky top-0 z-50 transition-all duration-300 ${isDashboard ? 'bg-white text-slate-800 border-b border-slate-200 shadow-sm h-16 flex items-center' : 'bg-indigo-600 text-white shadow-lg'}`}>
            ...
            <div className="flex items-center gap-6">
              {user && (
                <div className="flex items-center gap-4">
                  <div className="flex items-center gap-3 px-4 py-1.5 bg-slate-50 rounded-2xl border border-slate-100 min-w-[180px] justify-end">
                    ...
                    <div className="w-9 h-9 bg-indigo-600 rounded-full flex items-center justify-center text-white font-bold border-2 border-white shadow-sm shrink-0">
                      {user.name.charAt(0)}
                    </div>
                  </div>
                  ...
                  <button 
                    ...
                    className="flex items-center gap-2 px-4 py-2 bg-red-50 text-red-600 hover:bg-red-600 hover:text-white rounded-xl text-sm font-bold transition-all duration-200 border border-red-100 shadow-sm"
                  >
                    <LogOut size={18} />
